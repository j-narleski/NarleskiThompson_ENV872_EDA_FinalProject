...
# 2010 data
fattyacids_2010_raw <- read.csv(here("Data", "RawData", "2010_FattyAcids_Raw.csv"))
mercury_2010_raw <- read.csv(here("Data", "RawData", "2010_Mercury_Raw.csv"))
PCB_2010_raw <- read.csv(here("Data", "RawData", "2010_PCBs_Raw.csv"))
PFA_2010_raw <- read.csv(here("Data", "RawData", "2010_PFAs_Raw.csv"))

# 2015 data
fattyacids_2015_raw <- read.csv(here("Data", "RawData", "2015_FattyAcids_Raw.csv"))
mercury_2015_raw <- read.csv(here("Data", "RawData", "2015_Mercury_Raw.csv"))
PCB_2015_raw <- read.csv(here("Data", "RawData", "2015_PCBs_Raw.csv"))
PFA_2015_raw <- read.csv(here("Data", "RawData", "2015_PFAs_Raw.csv"))

# 2020 data
fattyacids_2020_raw <- read.csv(here("Data", "RawData", "2020_FattyAcids_Raw.csv"))
mercury_2020_raw <- read.csv(here("Data", "RawData", "2020_Mercury_Raw.csv"))
PCB_2020_raw <- read.csv(here("Data", "RawData", "2020_PCBs_Raw.csv"))
PFA_2020_raw <- read.csv(here("Data", "RawData", "2020_PFAs_Raw.csv"))

```

![test](https://natureconservancy-h.assetsadobe.com/is/image/content/dam/tnc/nature/en/photos/l/a/LakeHerring_PaulVecsei_AllRights_4000x2200.jpg?crop=0%2C0%2C4000%2C2200&wid=2000&hei=1100&scl=2.0)
...
write.csv(mercury_2010_processed, 
  here("Data", "ProcessedData", "2010_Mercury_Processed.csv"))
...
write.csv(mercury_2015_processed,
  here("Data", "ProcessedData", "2015_Mercury_Processed.csv"))
...
write.csv(mercury_2020_processed, 
 here("Data", "ProcessedData", "2020_Mercury_Processed.csv"))
...
write.csv(PFA_2010_processed, 
          here("Data", "ProcessedData", "2010_PFAs_Processed.csv"))
...
write.csv(PFA_2015_processed,
           here("Data", "ProcessedData", "2015_PFAs_Processed.csv"))
...
write.csv(PFA_2020_processed,
          here("Data", "ProcessedData", "2020_PFAs_Processed.csv"))
...
write.csv(PCB_2010_processed, 
          here("Data", "ProcessedData", "2010_PCBs_Processed.csv"))
...
write.csv(PCB_2015_processed,
          here("Data", "ProcessedData", "2015_PCBs_Processed.csv"))
...
write.csv(PCB_2020_processed,
          here("Data", "ProcessedData", "2020_PCBs_Processed.csv")) 
...
write.csv(fattyacids_2010_processed, here("Data", "ProcessedData", "2010_FattyAcids_Processed.csv")) 
...
write.csv(fattyacids_2015_processed, here("Data", "ProcessedData", "2015_FattyAcids_Processed.csv"))
...
write.csv(fattyacids_2020_processed, here("Data", "ProcessedData", "2020_FattyAcids_Processed.csv")) 
