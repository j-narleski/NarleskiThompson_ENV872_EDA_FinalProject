...
**add text explaining why omega 3 and explain why fish only** For these reasons, fatty acids are only grouped by fish species (Figure \@ref(fig:fatty-exp-fish) ).
<br>
...
PFA_by_lake <- ggplot(
 PFA_bylake_combined , aes(
    x = as.factor(Year), y = Total.PFAs, fill = Lake)) +
  geom_bar(stat = "identity", position = "dodge") +  
...
summary(PFA_bylake_2020_AOV)
  #p = 0.000736 (SIG)
'
#still need to do fatty acid(?) from the processed data
#should we do tukey test?
```
