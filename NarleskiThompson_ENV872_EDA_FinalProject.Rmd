...
<ol><b>
  ...
  <li>Are different species significantly more vulnerable than others to different contaminants? SHOULD WE CHANGE THIS ONE</li>
</b></ol>

<center>
**Table 1.** Description of the contaminants used in this project.[5]
</center>

<br>

| Contaminant   | Description | Effect on Human Health |
|:---:|:----|:---------|
| Mercury | A heavy metal that comes from sources such as factory outputs and landfill leaching | Reproductive, developmental, and sensory defects |
| Fatty Acids | Organic compounds found in the tissues of organisms; required in some amounts but negative in excess | Excessive intake can lead to cardiovascular diseases |
| PCBs | Industrial chemicals used in electrical equipment, plastics, and paints | Cancer, reproductive problems, and immune system suppression |
| PFAs | Man-made chemicals found in products that resist oil and grease (i.e. non-stick coatings) and fire-fighting foam | Associated with cancer, liver damage, thyroid disorders, and immune system suppression |
...
The Environmental Protection Agency has conducted periodic studies over the past 15 years assessing the coastal conditions of marine and the Great Lakes shores. We focus on data from 2010, 2015, and 2020. The basic structure of each is described below (Table 2). 

<center>
**Table 2.** Raw Dataset Column Descriptions
</center>
...
<br>
The basic structure of each of the raw datasets can be found in Table 3.1. The specific variables being investigated from  each of the processed files can be found below (Table 3.2). Additionally, while the total fatty acid content was combined, the types that were used for our specific study found in the data are listed along with their abbreviations (Table 3.4). This is due to the fact that some of the analytes in the 2015 and 2020 fatty acid studies were not measured in the 2010 study, and do not have nearly as much research and information on their impacts in comparison to the other analytes found in all 3 studies (Table 3.4).
<br>
<br>
...
| Fatty Acids | mg/g (millograms per gram)| ug/g (micrograms per gram) |
| PCBs | ng/g (nanograms per gram)  | ppb (parts per billion)|
| PFAs  | ng/g (nanograms per gram)  | ppb (parts per billion)|
<br>

**Table 3.4. Types of Fatty Acids**

| Fatty Acid | Type | Abbreviation |
|:----|:------|:------|
| alpha-Linolenic acid | Omega-3 | ALA |
| Docosahexaenoic acid | Omega-3 | DHA |
| Docosapentaenoic acid | Omega-3 | DPA |
| Eicosapentaenoic acid | Omega-3 | EPA |
| Eicosatrienoic acid   | Omega-3 | ETE |
| Linolenic acid | Omega-6| LA
...
## Mercury
Data on mercury is complete across all three time periods. Visualizations of the relationships between mean mercury levels and lake (Huron, Superior, Erie, Michigan, and Ontario), fish species, and niche (Benthic and Pelagic) are below (Figures 4.2-4.4).  
<br>
...
<br>
## PCBs
PCBs (Polychlorinated Biphenyls) are also a complete dataset. Visualizations are shown below (Figures 4.5-4.7).
